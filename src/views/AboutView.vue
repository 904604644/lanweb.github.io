              ...
              <div class="our-company-quote">
                <div class="am-g">
                  ...
                  <div class="am-u-md-6">
                    ...
                    <div class="our-company-quote_author">
                      <strong>吴总</strong><span>奥里斯电梯有限公司创始人</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="am-g">
              <div class="am-u-md-3">
                <div class="our_mission--item">
                  <div class="figure our_mission--item_media">
                    <img src="../assets/images/about/f02.jpg" alt="" />
                  </div>
              ...
              <div class="am-u-md-3">
                <div class="our_mission--item">
                  <div class="figure our_mission--item_media">
                    <img src="../assets/images/about/f03.jpg" alt="" />
                  </div>
              ...
              <div class="am-u-md-3">
                <div class="our_mission--item">
                  <div class="figure our_mission--item_media">
                    <img src="../assets/images/about/f04.jpg" alt="" />
                  </div>
              ...
              <div class="am-u-md-3">
                <div class="our_mission--item">
                  <div class="figure our_mission--item_media">
                    <img src="../assets/images/about/f01.jpg" alt="" />
                  </div>
                  <h3 class="our_mission--item_title">责任</h3>
                  <div class="our_mission--item_body">
                    <p>全球领先的HTML5解决方案供应商，安全高效解决企业移动化</p>
            ...
            <div class="am-g">
              ...
              >
                <div class="team-box">
                  <div
                    class="our-team-img"
                    style="height: 304px; overflow: hidden"
                  >
...
export default {
  ...
  methods: {
    getCompanyInfo() {
      this.getRequest("/findCompanyInfo").then((resp) => {
        if (resp) {
    ...
    getDesigners() {
      this.getRequest("/findDesigners").then((resp) => {
        if (resp) {
          this.designers = resp.data.data;
        }
      });
    },
  },
