<template>
  <Layout>
              ...
              <div class="index-banner">
                <div class="index-mask">
                  <div class="container">
                    <div class="am-g">
                      <div
                        class="am-u-md-10 am-u-sm-centered"
                      ...
                      >
                        ...
                        <p
                          class="slide_simple--text am-text-left"
            ...
            >
              <a href="#" @click.prevent="changeTab(index)">
                ...
                <div class="school-item-right am-u-md-9 am-u-sm-9 am-text-left">
                  <strong class="promo_slider_nav--item_title">{{
                    tab.name
                  }}</strong>
                  <p class="promo_slider_nav--item_description">
                    {{ tab.desc }}
                  </p>
                </div>
              </a>
    ...
    <div
      class="section"
      style="border-bottom: 1px solid #e9e9e9; padding-top: 0"
    >
      <div class="container" style="max-width: 1160px">
        <div class="section--header">
  ...
  data() {
    return {
      ...
      advantageList: [
        {
          id: 1,
          cover: require("../assets/images/index/f01.jpg"),
          title: "简单的适配过程",
      ...
      serviceList: [
        {
          ...
          title: "多页面工作",
          desc: "标签栏可切换，不必为了新内容而被迫跳转界面，多项工作内容并行处理",
        },
        {
          id: 2,
          icon: "am-icon-user",
        ...
        {
          id: 3,
          icon: "am-icon-umbrella",
          title: "多页面工作",
          desc: "标签栏可切换，不必为了新内容而被迫跳转界面，多项工作内容并行处理",
        },
        {
          id: 4,
          icon: "am-icon-briefcase",
          title: "多页面工作",
          desc: "标签栏可切换，不必为了新内容而被迫跳转界面，多项工作内容并行处理",
        },
      ],
