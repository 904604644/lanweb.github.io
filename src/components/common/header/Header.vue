    ...
    <div class="header">
      ...
      <div class="header-mid">
        ...
        <div class="header-item">
          ...
          <div class="item">
            <strong>广东省东莞市长安镇常荣南街5巷16号锦福名苑</strong>
            <span>小兰模具有限公司</span>
          </div>
        </div>
      </div>
      <div class="header-right">
        <a href="tel:+18824217569" class="">
    ...
    <div class="nav-wrapper header-default">
      <div class="nav">
        <ul class="am-nav am-nav-pills am-nav-justify">
          <li>
            <router-link class="router" to="/index">网站首页</router-link>
          </li>
          <li>
            <router-link class="router" to="/product">产品中心</router-link>
          </li>
          <li>
            <router-link class="router" to="/example">客户案例</router-link>
          </li>
          <li><router-link class="router" to="/news">公司动态</router-link></li>
          <li>
            <router-link class="router" to="/about">关于我们</router-link>
          </li>
        </ul>
      </div>
    </div>
